...
ggplot(controversial,aes(pv1,pv2)) + 
  ...
  scale_color_manual(values = c("Democrat" = "blue", "Republican" = "red"))+
  ggtitle("Figure2: Voting spread for More Splitting Issues") 
```
...
ggplot(controversial,aes(pv1,pv2)) + 
  ...
  ggtitle("Figure3: K-means clustering for More Splitting issues")  
controversial$pv3
```
...
ggplot(controversial,aes(pv1,pv2)) + 
  ...
  ggtitle("Figure4: Hierarchial clustering for More Splitting issues")  
```
